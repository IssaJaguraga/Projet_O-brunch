import{g as D}from"./index-YPhh3He9.js";function C(S,L){for(var d=0;d<L.length;d++){const w=L[d];if(typeof w!="string"&&!Array.isArray(w)){for(const y in w)if(y!=="default"&&!(y in S)){const O=Object.getOwnPropertyDescriptor(w,y);O&&Object.defineProperty(S,y,O.get?O:{enumerable:!0,get:()=>w[y]})}}}return Object.freeze(Object.defineProperty(S,Symbol.toStringTag,{value:"Module"}))}var U={exports:{}};(function(S){var L=function(){var d=!0,w=!1,y={},O=function(){var m,t,f={'"':'"',"\\":"\\","/":"/",b:"\b",f:"\f",n:`
